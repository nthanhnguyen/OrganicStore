...
public class AdminEditProductController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String area = request.getParameter("val-area");
		String huong = request.getParameter("val-h");
		String lapdat=request.getParameter("val-lapdat");
		...
		Products products = new Products(sProducts.getId(), IdC, productname, dependency, null, price, dis, idb, idb, sdate, endate, style, sl, address,area,huong,optradio,lapdat);
