																	...
																	<form class="form-valide"
																		...
																		<div class="row">
																			<div class="col-xl-6">
																				<div class="form-group row">
																					...
																					<div class="col-lg-6">
																						<input type="text" class="form-control"
																							placeholder="Nhấp trên sản phẩm" name="username" required="required">
																					</div>
																				</div>
																				<div class="form-group row">
																					...
																					<div class="col-lg-6">
																						<input type="text" class="form-control"
																							...
																							name="val-style" required="required">
																					</div>
																				</div>
																				...
																				<div class="form-group row">
																					<label class="col-lg-4 col-form-label"
																						for="var-status">Loại Sản Phẩm<span
																						class="text-danger">*</span>
																					</label>
																					<div class="col-lg-6">
																						<input type="radio" id="val-confirm-password"
																							name="var-status" placeholder="" > Mô Hình
																						<input type="radio" id="val-confirm-password"
																							name="var-status" ">
																						Sản Phẩm
																					</div>
																				...
																				<div class="form-group row">
																					<label class="col-lg-4 col-form-label"
																						for="var-status">Máy Lạnh<span
																						class="text-danger">*</span>
																					</label>
																					<div class="col-lg-6">
																						<label class="radio-inline"> <input
																							type="radio" name="optradio" >Có
																							
																						</label> <label class="radio-inline"> <input
																							type="radio" name="optradio">Không
																						</label>
																					</div>
																				</div>
																				...
																				<div class="form-group row">
																					<label class="col-lg-4 col-form-label"
																						for="val-lapdat">Lắp Đặt<span
																						class="text-danger">*</span>
																					</label>
																					<div class="col-lg-6">
																						<textarea class="form-control"
																							id="var-lapdat" name="val-lapdat"
																							rows="5" placeholder="Mô tả sản phẩm"></textarea>
																					</div>
																				</div>
																				<div class="form-group row">
																					...
																					<div class="col-lg-6">
																						<input type="file" id="upload_file" name="file"
																							onchange="preview_image();" class="form-control" required="required">
																					</div>
																			...
																			<div class="col-xl-6">
																				<div class="form-group row">
																					<label class="col-lg-4 col-form-label"
																						for="val-category">Điện Tích <span
																						class="text-danger">*</span>
																					</label>
																					<div class="col-lg-6">
																				...
																				<div class="form-group row">
																					...
																					<div class="col-lg-6">
																						<input type="number" class="form-control"
																							id="val-amount" name="val-amount" required="required">
																					</div>
																				</div>
																				<div class="form-group row">
																					<label class="col-lg-4 col-form-label"
