									...
									<form class="form-valide" action="AdminEditProductController"
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-4 col-form-label" for="var-status">
													...
													<div class="col-lg-6">
														...
														Mô Hình <input type="checkbox" id="val-confirm-password"
															name="var-status" placeholder="..and confirm it!">
														Sản Phẩm
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-4 col-form-label" for="var-status">Máy
														Lạnh<span class="text-danger">*</span>
													</label>
													<div class="col-lg-6">
												...
												<div class="form-group row">
													<label class="col-lg-4 col-form-label" for="val-lapdat">Lắp
														Đặt<span class="text-danger">*</span>
													</label>
													<div class="col-lg-6">
														<textarea class="form-control" id="var-lapdat"
															name="val-lapdat" rows="5" placeholder="Mô tả sản phẩm"><%=p.getLapdat()%></textarea>
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-4 col-form-label" for="val-category">Điện
														Tích <span class="text-danger">*</span>
													</label>
													<div class="col-lg-6">
														<select class="form-control" id="val-category"
															name="val-area">

															<option value="S1">Dười 30m2</option>
															<option value="S2">30-50m2</option>
															<option value="S3">50-80m2</option>
															<option value="S4">trên 80m2</option>

														</select>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-4 col-form-label" for="val-category">Hướng
														<span class="text-danger">*</span>
													</label>
													<div class="col-lg-6">
														<select class="form-control" id="val-category"
															...
															<option value="H1">Chánh Đông</option>
															<option value="H2">Chánh Nam</option>
															<option value="H3">Chánh Tây</option>
															<option value="H4">Chánh Bắc</option>
