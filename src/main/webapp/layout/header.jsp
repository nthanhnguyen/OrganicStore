				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="header__top__right">
							...
							<div class="header__top__right__language">
								<img src="viewroot/img/vietnam.png" alt="">
								<div>VietNam</div>
								<!-- <span class="arrow_carrot-down"></span> -->
<!-- 								<ul>
				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							...
							<li><a href="HomeProductsServlet?type=SP">SẢN PHẨM</a></li>
							<li><a href="#">MÔ HÌNH</a>
								<ul class="header__menu__dropdown">
									<%
													for (Category ds : category.getListCategory()) {
														if("MH".equals(ds.getType())){
												%>
									<li><a
										href="HomeProductsServlet?type=MH&id_category=<%=ds.getId()%>"><%=ds.getTenLoaiSanPham()%>
									</a></li>
									<%
														}	}
												%>
