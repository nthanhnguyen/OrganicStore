					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								...
								<div class="blog__item__text">
									<ul>
										<li><i class="fa fa-calendar-o"></i> 1 tháng 12 năm 2022</li>
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								...
								<div class="blog__item__text">
									<ul>
										<li><i class="fa fa-calendar-o"></i> 29 tháng 11 năm 2022</li>
										<!-- <li><i class="fa fa-comment-o"></i> 5</li> -->
									</ul>
									<h5>
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								...
								<div class="blog__item__text">
									<ul>
										<li><i class="fa fa-calendar-o"></i> 12 tháng 11 năm 2022</li>
										<!-- <li><i class="fa fa-comment-o"></i> 5</li> -->
									</ul>
									<h5>
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								...
								<div class="blog__item__text">
									<ul>
										<li><i class="fa fa-calendar-o"></i> 10 tháng 11 năm 2022</li>
										<!-- <li><i class="fa fa-comment-o"></i> 5</li> -->
									</ul>
									<h5>
										<a href="#">Mẹo nấu ăn giúp việc nấu ăn trở nên đơn giản</a>
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								...
								<div class="blog__item__text">
									<ul>
										<li><i class="fa fa-calendar-o"></i> 1 tháng 11 năm 2022</li>
										<!-- <li><i class="fa fa-comment-o"></i> 5</li> -->
									</ul>
									<h5>
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								...
								<div class="blog__item__text">
									<ul>
										<li><i class="fa fa-calendar-o"></i> 30 tháng 10 năm 2022</li>
									</ul>
									<h5>
										<a href="#">Khoảnh khắc bạn cần loại bỏ tỏi khỏi thực đơn</a>
									</h5>
